						...
						<div class="col-md-9">
							<div class="panel panel-primary">
							  <div class="panel-heading">
							    <img src="imagens/calendario48.png" alt="Calendário" style="margin-right:10px;width:32px;height:32px;">Novo Compromisso
							  </div>
							  	...
							  	<form action="GravarCompromissoServlet" method="POST">
									  ...
									  <div class="form-row">
									    <div class="form-group col-md-6">
									      ...
									      <input type="text" class="form-control" name="txtDtInicio" placeholder="Digite a data do início..." required>
									    </div>
									    <div class="form-group col-md-6">
									  ...
									  <div class="form-row">
									    <div class="form-group col-md-6">
									      ...
									      <input type="text" class="form-control" name="txtHrInicio" placeholder="Digite o horário do início..." required>
									    </div>
									    <div class="form-group col-md-6">
									      <label for="txtHrFim">Horário do Fim:</label>
									      <input type="text" class="form-control" name="txtHrFim" placeholder="Digite o horário do fim..." required>
									    </div>
									  </div>
									  ...
									  <div class="form-row">
									    <div class="form-group col-md-12">
									      ...
									      <input type="text" class="form-control" name="txtDescricao" placeholder="Digite a descrição do compromisso..." required>
									    </div>
									  </div>
									  <div class="form-row">
									    <div class="form-group col-md-12">
